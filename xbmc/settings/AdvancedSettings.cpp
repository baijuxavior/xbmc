...
//#endif
  ...
  m_discStubExtensions = ".disc";
	m_sbs3dtags = "3DSBS|3D.SBS|HSBS|H.SBS|H-SBS| SBS ";
	m_tab3dtags = "3DTAB|3D.TAB|HTAB|H.TAB|3DOU|3D.OU|3D.HOU| HOU | OU ";
...
void CAdvancedSettings::ParseSettingsFile(const CStdString &file)
{
  ...
  if (pElement)
  {
		XMLUtils::GetString(pElement, "sbs3dtags", m_sbs3dtags);
		XMLUtils::GetString(pElement, "tab3dtags", m_tab3dtags);
